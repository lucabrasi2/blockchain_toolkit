...
class BaseProvider(ABC):
    ...
    * Connection caching
    ...
    def connect(self) -> Web3:
        ...
        self._statistics.last_latency_ms = (
            latency
        )

        self._statistics.total_latency_ms += (
            latency
        )

        self._statistics.last_success = (
            datetime.utcnow()
        )
        ...
        self._statistics.uptime_started = (
            self._connected_since
        )
    ...
    def get_provider_info(self) -> dict[str, Any]:
        ...
        return {
            ...
            "statistics": {
                ...
                "reconnect_attempts":
                    self.statistics.reconnect_attempts,
                ...
                "last_latency_ms":
                    self.statistics.last_latency_ms,
    ...
    def before_request(self) -> None:
        ...
        Default implementation intentionally
        performs no action.
        """
